...
class UTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: USize.fontSizeMd, color: UColors.black),
    hintStyle: const TextStyle().copyWith(fontSize: USize.fontSizeSm, color: UColors.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle: const TextStyle().copyWith(color: UColors.black.withValues(alpha: 0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(USize.inputFieldsRadius),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    prefixIconColor: UColors.darkGrey,
    suffixIconColor: UColors.darkGrey,
    labelStyle: const TextStyle().copyWith(fontSize: USize.fontSizeMd, color: UColors.white),
    hintStyle: const TextStyle().copyWith(fontSize: USize.fontSizeSm, color: UColors.white),
